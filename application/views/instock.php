   ...
   <!-- /#left-panel -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            ...
            <div class="col-lg-12">
                <?php echo form_open_multipart('StockController/instock_store') ?>
                                             <div class="card">
                                                    <div class="card-header">
                                                        <strong>Instock barang</strong>
                                                    </div>
                                                    <div class="card-body card-block">
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="select" class=" form-control-label">Kode Barang</label></div>
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text" id="nama_barang" name="nama_barang" placeholder="" class="form-control" required="y" >
                                                             ...
                                                             <div class="row form-group">
                                                                <div class="col col-md-3"><label for="password-input" class=" form-control-label">Ref</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="reference" name="reference" placeholder="" class="form-control" >
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                           ...
                                                           <!--  <div class="row form-group">
                                                            ...
                                                            <div class="row form-group">
                                                             ...
                                                             <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text" id="process" name="process" placeholder="" class="form-control" value="IN" readonly=""></div>
                                                            </div>
                 ...
                 <div class="body">
                            <div class="table-responsive">
                                <table id="tabel_instock" class="table table-bordered text-center table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        <tr bgcolor="#b9b9b9">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                          ...
                                          <td>
                                            ...
                                            <a href="<?php echo base_url() ?>StockController/delete_instock/<?php echo $hasil['no_id'] ?>" class="badge badge-danger" onclick="return confirm('Yakin akan dihapus')">Delete</a>
                                            </td>
                                        </tr>
